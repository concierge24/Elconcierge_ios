...
public class RangeSlider: UIControl {
    ...
    var gapBetweenThumbs: Double {
        return 10//0.5 * Double(thumbWidth) * (maximumValue - minimumValue) / Double(bounds.width)
    }
    ...
    override public func beginTracking(_ touch: UITouch, with event: UIEvent?) -> Bool {
        ...
        if upperThumbLayer.x - lowerThumbLayer.x < 10 {
//            if lowerThumbLayer.frame.contains(previouslocation) && !movingRight {
//                lowerThumbLayer.highlighted = true
//                print("lower highlighted")
//            }
//            else
            
            
            if lowerThumbLayer.frame.contains(previouslocation) && upperValue > (maximumValue - 20) {
                lowerThumbLayer.highlighted = true
            }
    ...
    public override func touchesMoved(_ touches: Set<UITouch>, with event: UIEvent?) {
        ...
        let newLocation = aTouch.location(in: self)
