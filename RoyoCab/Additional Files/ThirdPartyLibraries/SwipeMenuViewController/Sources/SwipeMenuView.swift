...
public struct SwipeMenuViewOptions {
    ...
    public struct TabView {
        ...
        public struct ItemView {
            ...
            public var width: CGFloat = 150.0

            /// ItemView side margin. Defaults to `5.0`.
            public var margin: CGFloat = 28.0

            /// ItemView font. Defaults to `14 pt as bold SystemFont`.
            public var font: UIFont = UIFont.init(name: "Mont-Bold", size: 16)!

            /// ItemView clipsToBounds. Defaults to `true`.
            public var clipsToBounds: Bool = true

            /// ItemView textColor. Defaults to `.lightGray`.
            public var textColor: UIColor = UIColor(red:0.0, green:0.0, blue:0.0, alpha:0.75)

            /// ItemView selected textColor. Defaults to `.black`.
            public var selectedTextColor: UIColor =  UIColor(red:0.14, green:0.60, blue:0.82, alpha:1)
        }
        ...
        public struct AdditionView {
            ...
            public var backgroundColor: UIColor =  UIColor(red:0.14, green:0.60, blue:0.82, alpha:1)
        ...
        public var height: CGFloat = 46.0
