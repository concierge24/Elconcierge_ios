 ...
 */
@IBDesignable
open class SkyFloatingLabelTextField: AnimatableTextField { // swiftlint:disable:this type_body_length
  /**
  ...
  @objc dynamic open var titleFont: UIFont = R.font.sfProTextBold(size: 14.0) ?? UIFont.systemFont(ofSize: 14, weight: UIFont.Weight(rawValue: 700)) {
    didSet {
      updateTitleLabel()
    }
  }
