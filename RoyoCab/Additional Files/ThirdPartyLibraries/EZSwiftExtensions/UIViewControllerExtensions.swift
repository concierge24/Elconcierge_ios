...
// swiftlint:disable trailing_whitespace
  ...
  import UIKit
    ...
    extension UINavigationController {
            ...
            func popPushToVC(ofKind kind: AnyClass) {
  ...
  extension UIViewController {
    ...
    func popVC<T: UIViewController>(to type: T.Type) {
    ...
    open func presentVC(_ vc: UIViewController , _ animated : Bool) {
    ...
    open func removeChildViewController() {
