...
public class SweetAlert: UIViewController {
    ...
    private func setupTitleLabel() {
        ...
        titleLabel.font = UIFont(name: Fonts.ProximaNova.Regular, size:20)
    ...
    private func setupSubtitleTextView() {
        ...
        subTitleTextView.font = UIFont(name: Fonts.ProximaNova.Regular, size:14)
    ...
    private func resizeAndRelayout() {
        ...
        if self.subTitleTextView.text.isEmpty == false {
            ...
            textViewHeight = ceil(rect.size.height) + 25.0
        ...
        for i in 0 ..< buttons.count {
            ...
            buttons[i].addTarget(self, action: #selector(SweetAlert.pressed(sender:)), for: UIControl.Event.touchUpInside)
    ...
    public override func viewWillLayoutSubviews() {
        ...
        if ver < 8.0 {
            ...
            if UIInterfaceOrientation.portrait.isLandscape {
                let ssz = sz
    ...
    public func showAlert(title: String) -> SweetAlert {
        let alert = showAlert(title: title, subTitle: nil, style: .None)
        return alert
    }
    
    public func showAlert(title: String, subTitle: String?, style: AlertStyle) -> SweetAlert {
        let alert = showAlert(title: title, subTitle: subTitle, style: style, buttonTitle: "OK")
        return alert
    ...
    public func showAlert(title: String, subTitle: String?, style: AlertStyle,buttonTitle: String, action: ((_ isOtherButton: Bool) -> Void)? = nil) -> SweetAlert {
        let alert = showAlert(title: title, subTitle: subTitle, style: style, buttonTitle: buttonTitle, buttonColor: UIColor.colorFromRGB(rgbValue: 0xAEDEF4))
        userAction = action
        return alert
    }
    ...
    public func showAlert(title: String, subTitle: String?, style: AlertStyle,buttonTitle: String,buttonColor: UIColor,action: ((_ isOtherButton: Bool) -> Void)? = nil) -> SweetAlert {
        let alert = showAlert(title: title, subTitle: subTitle, style: style, buttonTitle: buttonTitle,buttonColor: buttonColor,otherButtonTitle:
            nil)
        userAction = action
        return alert
    }
    ...
    public func showAlert(title: String, subTitle: String?, style: AlertStyle,buttonTitle: String,buttonColor: UIColor,otherButtonTitle:
        ...
        window.bringSubviewToFront(view)
            ...
            if otherButtonTitle != nil && otherButtonTitle!.isEmpty == false {
                ...
                button.addTarget(self, action: #selector(SweetAlert.pressed(sender:)), for: UIControl.Event.touchUpInside)
                button.tag = 1
                buttons.append(button)
            }
